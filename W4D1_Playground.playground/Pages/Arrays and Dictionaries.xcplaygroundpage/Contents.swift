...
var bArray : [String] = ["Hello"];

var myArr: Array<String>! = ["Hello", "Vancouver"];

myArr.insert("Wearther", at: 1)
myArr.append("Hastings");
...
/*
 ...
 {
    cell = tableView.dequeresuableCell(identifider: "cell") as! MyCustomCell;
 }
 else
 {
 cell = tableView.dequeresuableCell(identifider: "cell") as! OtherCustomCell;
 }
...
var myDict2 : Dictionary<String, Any>! = Dictionary();

myDict["Weather"] = "rainy";
